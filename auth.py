...
class AuthSystem:
    ...
    def __init__(self, db_path="avicena_auth.db"):
        ...
        # A inicialização do banco de dados será feita sob demanda (lazy initialization)
        # para evitar conflitos de conexão na inicialização do app.
    ...
    def init_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            # All database operations must be INSIDE the 'with' block.
            # Tabela de usuários
            cursor.execute('''
    ...
    def authenticate(self, username, password):
        ...
        # Garante que o banco de dados exista antes de tentar autenticar
        self.init_database()
